...
param alertDescription string = 'Key is near expiry or expired'
...
@minLength(1)
param query string = 'AzureDiagnostics | where OperationName == "KeyNearExpiryEventGridNotification" or OperationName == "KeyExpiredEventGridNotification"'
