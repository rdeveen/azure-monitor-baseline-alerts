...
param alertDescription string = 'Secret is near expiry or expired'
...
@minLength(1)
param query string = 'AzureDiagnostics | where OperationName == "SecretNearExpiryEventGridNotification" or OperationName == "SecretExpiredEventGridNotification"'
