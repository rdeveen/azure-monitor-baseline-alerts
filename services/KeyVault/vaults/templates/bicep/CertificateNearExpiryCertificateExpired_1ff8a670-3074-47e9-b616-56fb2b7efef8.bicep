...
param alertDescription string = 'Certificate is near expiry or expired'
...
@minLength(1)
param query string = 'AzureDiagnostics | where OperationName == "CertificateNearExpiryEventGridNotification" or OperationName == "CertificateExpiredEventGridNotification"'
